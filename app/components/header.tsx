        ...
        <div className="relative">
          ...
          {isSettingsOpen && (
            <div className="absolute right-0 top-full mt-2 w-56 bg-[#0a0a0a] border border-[#222] rounded-lg shadow-xl flex flex-col py-2 overflow-hidden">
              ...
              <button className="flex items-center justify-between px-3 py-2 hover:bg-[#1a1a1a] transition-colors w-full text-left">
                <span className="text-xs text-[#8b8b8b]">Exportar como</span>
                <span className="text-[10px] text-white font-medium bg-[#111] px-1.5 py-0.5 rounded border border-[#333]">
                  PNG
                </span>
              </button>
              ...
              <button className="flex items-center justify-between px-3 py-2 hover:bg-[#1a1a1a] transition-colors w-full text-left group">
                <span className="text-xs text-[#8b8b8b]">Marca d'água</span>
                <div className="w-6 h-3.5 bg-[#222] rounded-full flex items-center px-0.5 border border-[#333] transition-colors group-hover:border-[#555]">
                  <div className="w-2.5 h-2.5 bg-[#8b8b8b] rounded-full" />
                </div>
              </button>
            </div>
          )}
