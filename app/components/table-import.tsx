...
export function TableImport({ onImport }: TableImportProps) {
  ...
  if (!isOpen) {
    return (
      ...
      >
        {t.tableImport.trigger}
      </button>
    );
  }

  return (
    <div className="w-full w-full animate-in fade-in zoom-in-95 duration-200">
      <div className="relative rounded-xl bg-[#0c0c0c] border border-[#2a2a2a] shadow-2xl focus-within:border-[#555] transition-colors">
        ...
        <textarea
          ...
          placeholder={t.tableImport.placeholder}
          rows={4}
          spellCheck={false}
